...
public class BullsCows {
    ...
    public static String generateSecretCode() {
        ...
        while(secretCode.length() < secretCodeLength){
            ...
            if(!secretCode.toString().contains(String.valueOf(syntax.charAt(random)))) secretCode.append(syntax.charAt(random));
        }
    ...
    public static void checkAnswer(String secretCode){
        ...
        while(true) {
            ...
            if (cow != 0 && bull != 0) System.out.printf("Grade: %d bull(s) and %d cow(s). The secret code is %s.",bull,cow,secretCode);
